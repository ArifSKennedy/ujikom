    ...
    public function data()
    {
        ...
        return datatables()
            ...
            ->addColumn('aksi', function ($member) {
                return '
                <div class="">
                    <button type="button" onclick="editForm(`'. route('member.update', $member->id_member) .'`)" class="btn btn-sm btn-dark"><i class="bi bi-pencil-fill"></i> Edit</button>
                    <button type="button" onclick="deleteData(`'. route('member.destroy', $member->id_member) .'`)" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Hapus</button>
                </div>
                ';
            })
